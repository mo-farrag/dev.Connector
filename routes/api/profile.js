...
//@desc     get currect user's profile route
//@access   private
router.get(
  "/",
...
//@desc     create or edit user's profile route
//@access   private
router.post(
  "/",
  passport.authenticate("jwt", { session: false }),
  ...
  (req, res) => {
    ...
    Profile.findOne({ user: req.user.id }).then((profile) => {
      if (profile) {
        ...
        //add experienceto the top of the experience collection
  ...
  (req, res) => {
    ...
    Profile.findOne({ user: req.user.id }).then((profile) => {
      if (profile) {
        ...
        //add education to the top of the experience collection
